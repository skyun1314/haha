// $ANTLR 3.5.2 smaliParser.g 2019-10-07 01:35:10
...
public class smaliParser extends Parser {
	...
	public final smali_file_return smali_file() throws RecognitionException {
		...
		try {
			...
			stream_EOF.add(EOF8);
			    ...
			    if (!smali_file_stack.peek().hasSuperSpec) {
			      if (!(class_spec1!=null?((class_spec_return)class_spec1).className:null).equals("Ljava/lang/Object;")) {
			        throw new SemanticException(input, "The file must contain a .super directive");
			      }
			    }
			  
			// AST REWRITE
			// elements: super_spec, implements_spec, field, class_spec, source_spec, method
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try {
			...
			switch (alt5) {
				case 1 :
					...
					// AST REWRITE
					// elements: access_list, nonvoid_type_descriptor, annotation, literal, member_name
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
	...
	public final statements_and_directives_return statements_and_directives() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: registers_directive, ordered_method_item, catchall_directive, catch_directive, parameter_directive
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final call_site_reference_return call_site_reference() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: simple_name, STRING_LITERAL, method_reference, method_prototype, literal
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final local_directive_return local_directive() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: name, NULL_LITERAL, signature, REGISTER, nonvoid_type_descriptor
	...
	public final insn_format21lh_return insn_format21lh() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: REGISTER, INSTRUCTION_FORMAT21lh, fixed_32bit_literal
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final insn_format22b_return insn_format22b() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: REGISTER, REGISTER, INSTRUCTION_FORMAT22b, integral_literal
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final insn_format22c_field_return insn_format22c_field() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: field_reference, REGISTER, REGISTER, INSTRUCTION_FORMAT22c_FIELD
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final insn_format22c_field_odex_return insn_format22c_field_odex() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: REGISTER, field_reference, INSTRUCTION_FORMAT22c_FIELD_ODEX, REGISTER
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final insn_format22s_return insn_format22s() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: integral_literal, instruction_format22s, REGISTER, REGISTER
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final insn_format45cc_method_return insn_format45cc_method() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: method_reference, method_prototype, register_list, INSTRUCTION_FORMAT45cc_METHOD
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final insn_format4rcc_method_return insn_format4rcc_method() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: method_reference, method_prototype, INSTRUCTION_FORMAT4rcc_METHOD, register_range
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final insn_array_data_directive_return insn_array_data_directive() throws RecognitionException {
		...
		try {
			...
			stream_parsed_integer_literal.add(parsed_integer_literal544.getTree());
			        ...
			        int elementWidth = (parsed_integer_literal544!=null?((parsed_integer_literal_return)parsed_integer_literal544).value:0);
