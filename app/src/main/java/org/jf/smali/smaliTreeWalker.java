// $ANTLR 3.5.2 smaliTreeWalker.g 2019-10-07 01:35:10
...
public class smaliTreeWalker extends TreeParser {
	...
	public final ClassDef smali_file() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			    ...
			    classDef = dexBuilder.internClassDef((header1!=null?((header_return)header1).classType:null), (header1!=null?((header_return)header1).accessFlags:0), (header1!=null?((header_return)header1).superType:null),
			            (header1!=null?((header_return)header1).implementsList:null), (header1!=null?((header_return)header1).sourceSpec:null), annotations2, fields3, methods4);
	...
	public final header_return header() throws RecognitionException {
		...
		try {
			...
			state._fsp--;
			    ...
			    classType = (class_spec5!=null?((class_spec_return)class_spec5).type:null);
	...
	public final BuilderField field() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			    ...
			    field = dexBuilder.internField(classType, (SIMPLE_NAME20!=null?SIMPLE_NAME20.getText():null), (nonvoid_type_descriptor21!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor21).type:null), access_list18,
			...
			switch (alt9) {
				...
				case 13 :
					...
					state._fsp--;
					 ...
					 encodedValue = new ImmutableAnnotationEncodedValue((subannotation35!=null?((subannotation_return)subannotation35).annotationType:null), (subannotation35!=null?((subannotation_return)subannotation35).elements:null));
					}
					break;
				case 14 :
		...
		try {
			...
			state._fsp--;
			        ...
			        method_stack.peek().methodParameterRegisters =
			                MethodUtil.getParameterRegisterCount((method_name_and_prototype69!=null?((method_name_and_prototype_return)method_name_and_prototype69).parameters:null), method_stack.peek().isStatic);
			...
			switch (alt16) {
				case 1 :
					...
					state._fsp--;
					          ...
					          if ((registers_directive70!=null?((registers_directive_return)registers_directive70).isLocalsDirective:false)) {
					            method_stack.peek().totalMethodRegisters = (registers_directive70!=null?((registers_directive_return)registers_directive70).registers:0) + method_stack.peek().methodParameterRegisters;
					          } else {
					            method_stack.peek().totalMethodRegisters = (registers_directive70!=null?((registers_directive_return)registers_directive70).registers:0);
					          }
			...
			parameters((method_name_and_prototype69!=null?((method_name_and_prototype_return)method_name_and_prototype69).parameters:null));
			state._fsp--;
			...
			match(input, Token.UP, null); 
			    ...
			    ret = dexBuilder.internMethod(
			            classType,
			            (method_name_and_prototype69!=null?((method_name_and_prototype_return)method_name_and_prototype69).name:null),
			            (method_name_and_prototype69!=null?((method_name_and_prototype_return)method_name_and_prototype69).parameters:null),
			            (method_name_and_prototype69!=null?((method_name_and_prototype_return)method_name_and_prototype69).returnType:null),
			            accessFlags,
			            annotations73,
			...
			while (true) {
				...
				case 1 :
					...
					state._fsp--;
					        ...
					        types.add((nonvoid_type_descriptor78!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor78).type:null));
		...
		try {
			...
			switch (alt18) {
			    ...
			    if ((field_reference82!=null?(input.getTokenStream().toString(input.getTreeAdaptor().getTokenStartIndex(field_reference82.start),input.getTreeAdaptor().getTokenStopIndex(field_reference82.start))):null) != null) {
			        reference = (field_reference82!=null?((field_reference_return)field_reference82).fieldReference:null);
			    } else {
			        reference = method_reference83;
			    }
			    methodHandle = new ImmutableMethodHandleReference((method_handle_type84!=null?((method_handle_type_return)method_handle_type84).methodHandleType:0), reference);
	...
	public final ImmutableMethodReference method_reference() throws RecognitionException {
		...
		try {
			...
			state._fsp--;
			    ...
			    String type;
			    if ((reference_type_descriptor86!=null?((reference_type_descriptor_return)reference_type_descriptor86).type:null) == null) {
			        type = classType;
			    } else {
			        type = (reference_type_descriptor86!=null?((reference_type_descriptor_return)reference_type_descriptor86).type:null);
			    }
	...
	public final field_reference_return field_reference() throws RecognitionException {
		...
		try {
			...
			state._fsp--;
			    ...
			    String type;
			    if ((reference_type_descriptor89!=null?((reference_type_descriptor_return)reference_type_descriptor89).type:null) == null) {
			        type = classType;
			    } else {
			        type = (reference_type_descriptor89!=null?((reference_type_descriptor_return)reference_type_descriptor89).type:null);
			    }
			    retval.fieldReference = new ImmutableFieldReference(type, (SIMPLE_NAME90!=null?SIMPLE_NAME90.getText():null),
			            (nonvoid_type_descriptor91!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor91).type:null));
	...
	public final void catch_directive() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			    ...
			    method_stack.peek().methodBuilder.addCatch(dexBuilder.internTypeReference((nonvoid_type_descriptor94!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor94).type:null)),
			        from, to, using);
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      method_stack.peek().methodBuilder.addStartLocal(registerNumber,
			              ...
			              dexBuilder.internNullableTypeReference((nonvoid_type_descriptor101!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor101).type:null)),
			...
			switch (alt37) {
				...
				case 2 :
					...
					state._fsp--;
					    ...
					    reference = (field_reference111!=null?((field_reference_return)field_reference111).fieldReference:null);
	...
	public final void insn_format21c_field() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      ImmutableFieldReference fieldReference = (field_reference129!=null?((field_reference_return)field_reference129).fieldReference:null);
	...
	public final void insn_format21c_type() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      method_stack.peek().methodBuilder.addInstruction(new BuilderInstruction21c(opcode, regA,
			              dexBuilder.internTypeReference((nonvoid_type_descriptor139!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor139).type:null))));
	...
	public final void insn_format22c_field() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      ImmutableFieldReference fieldReference = (field_reference154!=null?((field_reference_return)field_reference154).fieldReference:null);
	...
	public final void insn_format22c_type() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      method_stack.peek().methodBuilder.addInstruction(new BuilderInstruction22c(opcode, regA, regB,
			              dexBuilder.internTypeReference((nonvoid_type_descriptor156!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor156).type:null))));
	...
	public final void insn_format35c_call_site() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			        ...
			        byte[] registers = (register_list176!=null?((register_list_return)register_list176).registers:null);
			        byte registerCount = (register_list176!=null?((register_list_return)register_list176).registerCount:0);
	...
	public final void insn_format35c_method() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      //this depends on the fact that register_list returns a byte[5]
			      byte[] registers = (register_list179!=null?((register_list_return)register_list179).registers:null);
			      byte registerCount = (register_list179!=null?((register_list_return)register_list179).registerCount:0);
	...
	public final void insn_format35c_type() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      //this depends on the fact that register_list returns a byte[5]
			      byte[] registers = (register_list182!=null?((register_list_return)register_list182).registers:null);
			      byte registerCount = (register_list182!=null?((register_list_return)register_list182).registerCount:0);

			      method_stack.peek().methodBuilder.addInstruction(new BuilderInstruction35c(opcode, registerCount, registers[0], registers[1],
			              registers[2], registers[3], registers[4], dexBuilder.internTypeReference((nonvoid_type_descriptor183!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor183).type:null))));
	...
	public final void insn_format3rc_call_site() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			        ...
			        int startRegister = (register_range185!=null?((register_range_return)register_range185).startRegister:0);
			        int endRegister = (register_range185!=null?((register_range_return)register_range185).endRegister:0);
	...
	public final void insn_format3rc_method() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      int startRegister = (register_range188!=null?((register_range_return)register_range188).startRegister:0);
			      int endRegister = (register_range188!=null?((register_range_return)register_range188).endRegister:0);
	...
	public final void insn_format3rc_type() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      int startRegister = (register_range191!=null?((register_range_return)register_range191).startRegister:0);
			      int endRegister = (register_range191!=null?((register_range_return)register_range191).endRegister:0);

			      int registerCount = endRegister-startRegister+1;

			      method_stack.peek().methodBuilder.addInstruction(new BuilderInstruction3rc(opcode, startRegister, registerCount,
			              dexBuilder.internTypeReference((nonvoid_type_descriptor192!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor192).type:null))));
	...
	public final void insn_format45cc_method() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      //this depends on the fact that register_list returns a byte[5]
			      byte[] registers = (register_list194!=null?((register_list_return)register_list194).registers:null);
			      byte registerCount = (register_list194!=null?((register_list_return)register_list194).registerCount:0);
	...
	public final void insn_format4rcc_method() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      int startRegister = (register_range198!=null?((register_range_return)register_range198).startRegister:0);
			      int endRegister = (register_range198!=null?((register_range_return)register_range198).endRegister:0);
		...
		try {
			...
			switch (alt42) {
				...
				case 2 :
					...
					type = (nonvoid_type_descriptor214!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor214).type:null);
					}
					break;
	...
	public final Annotation annotation() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      annotation = new ImmutableAnnotation(visibility, (subannotation236!=null?((subannotation_return)subannotation236).annotationType:null), (subannotation236!=null?((subannotation_return)subannotation236).elements:null));
	...
	public final ImmutableFieldReference field_literal() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      value = (field_reference241!=null?((field_reference_return)field_reference241).fieldReference:null);
	...
	public static final BitSet FOLLOW_I_ENCODED_METHOD_HANDLE_in_method_handle_literal1294 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_method_handle_reference_in_method_handle_literal1296 = new BitSet(new long[]{0x0000000000000008L});
